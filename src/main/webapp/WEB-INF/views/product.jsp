...
<script>
    $(function () {
        ...
        /* 
        	添加购物车
        	先检查用户是否已登录,已登录再进行下一步
       	*/
       	/*$(".addCartLink").click(function(){
        	 $.get(
        		"checkLogin.action",
        		function(data){ //data是后台返回给前端的数据
        			if("success" == data){
        				...
        				document.location.href="loginPage.action";
        			}
        		}
        	); 
    ...
    <div class="imgAndInfo">
        ...
        <div class="infoInimgAndInfo">
            ...
            <div class="productSaleAndReviewNumber">
                ...
                <div>累计评价<span class="redColor boldWord">${product.productReviewCount}</span></div>
            </div>
            ...
            <script>
                ...
                function buyLink() {
                    window.location = "buyNow.action?productId="+${product.id}+
                    "&number=" + $("#number").val();
                }
            </script>
            <div class="buyDiv">
...
<div class="productDetailDiv" style="display: block;">
    <div class="productDetailTopPart">
        ...
        <a class="productDetailTopReviewLink" href="#nowhere">累计评价 <span
                class="productDetailTopReviewLinkNumber">${product.productReviewCount}</span> </a>
    </div>
    ...
    <div class="productReviewTopPart">
        <div class="productReviewTopPart">
            ...
            <a class="selected" href="#nowhere">累计评价 <span
                    class="productReviewTopReviewLinkNumber">${product.productReviewCount}</span> </a>
        </div>
