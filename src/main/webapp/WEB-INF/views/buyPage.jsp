...
<div class="buyPageDiv">
    <form action="createOrders.action" method="post">
        ...
        <div class="productList">
            ...
            <table class="productListTable">
               ...
               <%--  <c:forEach items="${orderItems}" var="oi" varStatus="st">
                ...
                <c:forEach items="${ordersItemList}" var="ordersItem" varStatus="sta">
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="img/product/${ordersItem.productId}/1.jpg">
                        </td>
                        <td class="orderItemProductInfo">
                            <a href="foreproduct?pid=${ordersItem.productId}" class="orderItemProductLink">
                        ...
                        <td>
							￥<span>${ordersItem.product.price}</span>
                        </td>
                        <td>
                            <span class="orderItemProductNumber">${ordersItem.number}</span>
                        </td>
                        <td>
							￥<span>${ordersItem.product.price*ordersItem.number}</span>
                        </td>
            ...
            <div class="orderItemSumDiv">
                ...
                <span class="pull-right">店铺合计(含运费): ￥${totalMoney}</span>
            </div>
        ...
        <div class="orderItemTotalSumDiv">
            <div class="pull-right">
                <span>实付款：</span>
                <span class="orderItemTotalSumSpan">￥${totalMoney}</span>
            </div>
        </div>
